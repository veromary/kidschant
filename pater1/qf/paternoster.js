...
var qstHead;
var groups;
var quizTitle="Pater Noster Vocabulary";
var printCpRg=1;
var filename = 'paternoster';
...
function initShortQuestion() {
 ...
 qstHead[1]="Noster means:";
 qstHead[2]="Fill in the blanks in the first part of the Pater noster.";
 qstHead[3]="in terra means: ";
 qstHead[4]="Be hallowed in Latin is";
 qstHead[5]="Match up these words:";
 qstHead[6]="True or false?";
 qstHead[7]="Hodie means";
...
function SendResults() {
 sendwin = ManageDialog(CreateDialog('mysendwin','paternoster4.htm',400,320));
}
function goes() {
...
function Constructor() {
  ...
  typeOfQuest = new init_array(2,1,4,1,1,5,2,1,4,5,1,1,2,5,1);
